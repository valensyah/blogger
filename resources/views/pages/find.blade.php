...
@section('content')
  ...
  <div class="row p-4 p-md-0 p-sm-4">
    ...
    <a class="col-12 col-sm-6 col-md-4" href="{{ url('/news').'/'.$item->id }}" style="text-decoration: none !important">
      <div id="{{'card-'.$item->id}}" class="card mb-3" onmouseover="shadowEffect({{$item->id}})" onmouseout="removeShadow({{$item->id}})" style="min-height: 320px !important">
        ...
        <div class="card-body">
          <h5 class="card-title lh-sm fs-6 fw-semibold">{{ $item->title }}</h5>
