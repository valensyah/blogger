  ...
  <body>
    <nav class="navbar navbar-expand-lg bg-primary">
      <div class="container-fluid px-2 px-md-5">
        <a class="navbar-brand text-light" href="#">Postify</a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="d-flex me-2 mb-4 mb-lg-0" role="search" method="get" action="{{url('/find')}}">
            <input class="form-control me-2" type="search" placeholder="Search by title/tag" name="keyword" id="filter" aria-label="Search">
